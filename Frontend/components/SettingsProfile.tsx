                    ...
                    <div className="max-w-3xl mx-auto pb-20">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-10 p-6 bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700/50">
                            <div className="relative group cursor-pointer">
                                <div className="w-28 h-28 rounded-full bg-cover bg-center border-4 border-white dark:border-[#232f48] shadow-md" style={{ backgroundImage: `url('${CURRENT_USER.avatar}')` }}></div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <label className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className="w-full h-12 px-4 pl-9 rounded-lg border border-slate-200 dark:border-[#324467] bg-white dark:bg-[#192233] text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all placeholder-slate-400" type="text" defaultValue={CURRENT_USER.handle?.replace('@', '')} />
                                    </div>
                                </label>
                                <label className="flex flex-col gap-2">
