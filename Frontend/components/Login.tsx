...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  return (
    <div className="bg-background-light font-display h-screen flex items-center justify-center p-4 relative overflow-hidden text-gray-800">
      ...
      <main className="w-full max-w-[960px] h-[600px] bg-white rounded-2xl shadow-2xl flex overflow-hidden z-10 relative ring-1 ring-black/5">
        ...
        <div className="w-full md:w-7/12 bg-white relative p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="max-w-[380px] w-full mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm mt-2">请登录您的 TeleChat 账号</p>
            </div>
            <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); onLogin(); }}>
              <div>
                ...
                <div className="relative flex rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary transition-shadow">
                  ...
                  <input className="block w-full border-0 bg-transparent py-2.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" name="phone" placeholder="输入手机号码" type="tel" />
                </div>
              </div>
              <div>
                ...
                <div className="relative rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary transition-shadow">
                  <input className="block w-full border-0 bg-transparent py-2.5 pl-3 pr-10 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 rounded-lg" name="password" placeholder="输入密码" type="password" />
              ...
              <div className="pt-2">
                <button className="flex w-full justify-center rounded-lg bg-primary px-3 py-3 text-sm font-bold text-white shadow-lg shadow-primary/30 hover:bg-blue-600 hover:shadow-primary/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-all active:scale-[0.99]" type="submit">
                  登录
                </button>
              </div>
              <div className="flex items-center justify-center gap-1 mt-6 text-sm">
                <span className="text-gray-500">还没有账号？</span>
                <a className="font-bold text-primary hover:text-blue-700 hover:underline transition-colors" href="#">立即注册</a>
              </div>
            </form>
