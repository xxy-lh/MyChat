...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const body = isRegisterMode 
        ? { phone: phone.trim(), password, name: name.trim() }
  ...
  return (
    <div className="bg-background-light font-display h-screen flex items-center justify-center p-4 relative overflow-hidden text-gray-800">
      ...
      <main className="w-full max-w-[960px] h-[650px] bg-white rounded-2xl shadow-2xl flex overflow-hidden z-10 relative ring-1 ring-black/5">
